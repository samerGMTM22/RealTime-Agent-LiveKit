"""Fixed LiveKit Voice Agent with MCP Job Polling Integration"""
import logging
import os
import asyncio
import sys
...
async def entrypoint(ctx: JobContext):
    ...
    try:
        ...
        await session.generate_reply(
            instructions="Greet the user warmly and offer your assistance with web search capabilities."
        )
        
        logger.info("OpenAI Realtime API agent with MCP polling started successfully")
        ...
        # Function tools will be available as module-level functions
